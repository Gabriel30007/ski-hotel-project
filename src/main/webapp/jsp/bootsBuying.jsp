...
<header class="bg-dark py-5">
    <div class="container px-4 px-lg-5 my-5 pt-5">
        <div class="text-center text-white">
            <h1 class="display-4 fw-bolder">Лижні чоботи</h1>
...
<section class="py-5">
    <div class="container px-4 px-lg-5 mt-5">
        <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
            <!-- ПОЧАТОК КАРТКИ З СІРОЮ КНОПКОЮ З ТЕКСТОМ -->
            <c:if test="${not empty boots}">
                <c:forEach items="${boots}" var="currentBoots">
                    <div class="col mb-5">
                        <div class="card h-100">
                            <img class="card-img-top" src="data:image/jpg;base64, ${currentBoots.encodedImage}" alt="..."/>
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <h5 class="card-title fw-bolder fs-3">${currentBoots.size}</h5>
                                    <span class="card-text fs-4">${currentBoots.price}</span>
                                </div>
                            </div>
