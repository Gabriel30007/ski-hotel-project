...
<header class="bg-dark py-5">
    <div class="container px-4 px-lg-5 my-5 pt-5">
        <div class="text-center text-white">
            <h1 class="display-4 fw-bolder">Лижні палиці</h1>
...
<section class="py-5">
    <div class="container px-4 px-lg-5 mt-5">
        <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
            <c:if test="${not empty poles}">
                <c:forEach items="${poles}" var="currentPoles">
                    <div class="col mb-5">
                        <div class="card h-100">
                            <img class="card-img-top" src="data:image/jpg;base64, ${currentPoles.encodedImage}" alt="..."/>
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <h5 class="card-title fw-bolder fs-3">${currentPoles.height}</h5>
                                    <span class="card-text fs-4">${currentPoles.price}</span>
                                </div>
                            </div>
                            <div class="card-footer p-4 pt-1 border-top-0 bg-transparent">
                                <div class="text-center">
                                        <form:form action="${contextPath}/PolesToBucket" method="POST" enctype="multipart/form-data">
                                            <input type="hidden" value="${currentPoles.id}"
                                                   class="form-control" name="polesId">
