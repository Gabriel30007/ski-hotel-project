...
<div class="row w-100" style="padding-top: 175px;">
    <div class="col-lg-6 m-auto introducing p-5">
        ...
        <h5>
            Широкий вибір лиж відомих брендів. Продаж та прокат: палки, маски, шоломи, лижне
            спорядження.
        </h5>
        <h5>
            ...
            <form method="POST" action="${contextPath}/login" class="form form-login">
                <fieldset>
                    ...
                    <div class="input-block">
                        ...
                        <input id="login-password" class="password" name="password" type="password"
                               required>
                    </div>
...
<%--<script src="../resources/static/js/a.js">
    </script>--%>
