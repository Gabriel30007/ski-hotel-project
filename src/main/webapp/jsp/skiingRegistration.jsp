...
<%--    <link rel="stylesheet" href="../../resources/static/css/style_skiingRegistration.css">--%>
    <link rel="stylesheet" href="css/style.css">
    <link rel="stylesheet" href="css/style_main.css">
    <link rel="stylesheet" href="css/style_skiingRegistration.css">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.2/dist/css/bootstrap.min.css" rel="stylesheet"
          integrity="sha384-Zenh87qX5JnK2Jl0vWa8Ck2rdkQ2Bzep5IDxbcnCeuOxjzrPF/et3URy9Bv1WTRi" crossorigin="anonymous">
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.2/dist/js/bootstrap.bundle.min.js"
            integrity="sha384-OERcA2EqjJCMA+/3y+gxIOqMEjwtxJY7qPCqsdltbNJuaOe923+mo//f6V8Qbsw3"
            crossorigin="anonymous"></script>
    <title>Skiing Registration</title>
</head>
...
<br><br><br><br>
<div class="top row">
    <div class="topic col-sm-10"> Додавання лиж</div>
...
<form:form method="POST" action="${contextPath}/skiingSave" enctype="multipart/form-data">
    <div class="wrap row ">
        <input type="number" name="price" placeholder="Ціна" class="form-control, input-price col-xl-3"
               autofocus="true">
